                    ...
                    <div className="container-full d-flex justify-content-between align-items-center">
                        <div className="navbar-header">
                            ...
                            <Link className="navbar-brand" href="/">
                                <Image src="/assets/img/pancore-logo.png" className="logo desktop" alt="Pancore" width={790} height={240} />
                                <Image src="/assets/img/pancore-logo.png" className="logo logo-mobile" alt="Pancore" width={790} height={240} />
                            </Link>
                        </div>

                        <div className={`collapse navbar-collapse ${isOpen ? "show collapse-mobile" : "collapse-mobile"}`} id="navbar-menu">
                            <Image src="/assets/img/pancore-logo.png" alt="Pancore" width={790} height={240} />
